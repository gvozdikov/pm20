...
//   var now = new Date();
//   console.log(new Date(now.getFullYear(), now.getMonth(), now.getDate() + 1, now.getTime()));
//   db.flights.insert({
...
//   db.flights.insert({
//     "booking_number": flight_number,
//     "departure_date_time": new Date(now.getFullYear(), now.getMonth(), now.getDate() + 1, now.getTime())
//   });
//   db.flights.insert({
//     "booking_number": flight_number,
//     "departure_date_time": new Date(now.getFullYear(), now.getMonth(), now.getDate() - 1, now.getTime())
